        ...
        <form action="CancelMeetingServlet" method="post">
            <fieldset>
                ...
                <table class="formtable">
                    <input type="hidden" value="${mtid}" name="mtidto">
                    ...
                    <tr>
                        <td>预计参加人数：</td>
                        <td>${meeting.numuser}</td>
                    </tr>
                    <tr>
                        <td>预计开始时间：</td>
                        <td>${meeting.begindate} ${meeting.begintime}</td>
                    </tr>
                    <tr>
                        <td>预计结束时间：</td>
                        <td>${meeting.enddate} ${meeting.endtime}</td>
                    </tr>
                    <tr>
                        <td>会议说明：</td>
                        <td>
                            <textarea id="description" rows="5" readonly>${meeting.meetingthat}</textarea>
                        </td>
                    </tr>
                    <tr>
                        <td>参会人员：</td>
